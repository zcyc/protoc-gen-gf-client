...
// generateFile generates a _gf.pb.go file.
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by https://github.com/zcyc/protoc-gen-gf. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the zcyc/protoc-gen-gf-client package it is being compiled against.")
	g.P()
